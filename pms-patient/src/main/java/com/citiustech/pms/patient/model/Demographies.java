...
public class Demographies {
    ...
    public Demographies withPatientId(Integer patientId) {
        this.patientId = patientId;
        return this;
    }
    ...
    @JsonProperty("patient_portal_access")
    public String getPatient_portal_access() {
    ...
    public Demographies withPatient_portal_access(String patient_portal_access) {
        this.patient_portal_access = patient_portal_access;
        return this;
    }
    ...
    @JsonProperty("country_code")
    public void setCountryCd(Long country_code) {
        this.country_code = country_code;
    }

    public Demographies withCountryCd(Long country_code) {
        this.country_code = country_code;
        return this;
    }
